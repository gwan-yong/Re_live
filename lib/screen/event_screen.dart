...
class EventScreen extends StatefulWidget {
  ...
  })  : initialDate = initialDate ?? DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day), // 값이 없으면 현재 날짜 사용
        super(key: key);
...
class _EventScreen extends State<EventScreen> {
  ...
  IOSColorPickerController iosColorPickerController = IOSColorPickerController();
